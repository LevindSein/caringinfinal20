$(document).ready(function(){
    $('#tagihan').DataTable({
		...
		columns: [
            ...
            { data: 'sub_listrik', name: 'sub_listrik', class : 'text-center' },
            ...
            { data: 'sub_airbersih', name: 'sub_airbersih', class : 'text-center' },
            ...
            { data: 'sub_keamananipk', name: 'sub_keamananipk', class : 'text-center' },
            ...
            { data: 'sub_kebersihan', name: 'sub_kebersihan', class : 'text-center' },
            ...
            { data: 'sub_tagihan', name: 'sub_tagihan', class : 'text-center' },
