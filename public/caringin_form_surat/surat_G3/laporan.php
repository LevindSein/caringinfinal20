...
$awalmeterlistrik = $_POST['awalmeterlistrik'];
$ume1 = $_POST['ume1'];
$ume2 = $_POST['ume2'];
$ume3 = $_POST['ume3'];
// memanggil dan membaca template dokumen yang telah kita buat
$document = file_get_contents("G3.rtf");
...
$document = str_replace("#AWALMETERLISTRIK", $awalmeterlistrik, $document);
...
header("Content-disposition: inline; filename=pemasangan_meter_listrik.doc");
