...
<html lang="en">
    ...
    <body onload="window.print()">  
        @for($i=1;$i<=2;$i++)
        @if($i == 1)
        <h2 style="text-align:center;">REKAP PEMAKAIAN KEAMANAN & IPK<br>{{$bln}}</h2>
        <main>
            <table class="tg">
                <tr>
        ...
        @else
        <h2 style="text-align:center;page-break-before:always">RINCIAN PEMAKAIAN KEAMANAN & IPK<br>{{$bln}}</h2>
